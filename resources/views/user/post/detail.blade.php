        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-capitalize fw-bolder m-0 py-3 fs-5">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('post.index') }}" class="text-decoration-none">Tin tức</a>
                </li>
                <li class="breadcrumb-item" aria-current="page" class="">{{ $post->name }}</li>
            </ol>
        </nav>
                    ...
                    <div class="bg-white p-3 post-container">
                        ...
                        <div>
                            ...
                            <div class="row" id="content">
                                ...
                                @endphp
                                <x-share-social :model="$post" :shareLink="$shareLink" />
