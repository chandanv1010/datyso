        ...
        <form
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <textarea style="height:168px;" type="text" class="form-control" id="map"  name="map"
                        >{{ old('map') ?? (isset($item) ? $item->map : '') }}</textarea>
                    <p class="help is-danger text-danger map">{{ $errors->first('map') }}</p>
                </div>
            </div>
