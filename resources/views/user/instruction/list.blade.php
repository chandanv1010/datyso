    ...
    <div id="event-section" class="container mt-3">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-capitalize fw-bolder m-0 py-3 fs-5">
                ...
                <li class="breadcrumb-item"><a href="#" class="no-active">Chính sách</a></li>
            </ol>
        </nav>
        <div class="mt-3">
            <div style="border-bottom: 2px solid #002ab0; ">
                <h6 class="d-inline text-white pb-1 px-2 pt-1" style="background-color: #002ab0;">CHÍNH SÁCH</h6>
            </div>
            <div class="mt-3">
                <div class="row">
                        ...
                        <div class="col-sm-4 mb-3">
                            <div class="card border-0 rounded-4 bg-transparent h-100">
                                <img src="{{ $instruction->image }}"
                                    class="card-img-top rounded-4 w-100 shadow" alt="{{ $instruction->name }}"
                                ...
                                <div class="card-body py-2 px-0 d-flex flex-column">
                                    ...
                                    <p class="mb-0 fw-semibold mb-1 overflow-hidden text-nowrap"><a
                                            href="{{ route('instruction.detail', ['instructionSlug' => $instruction->slug]) }}"
                                            class="text-decoration-none text-black">{{ $instruction->name }}</a></p>
                                    <a href="{{ route('instruction.detail', ['instructionSlug' => $instruction->slug]) }}"
